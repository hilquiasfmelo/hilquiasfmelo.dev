export function WorkItem({ year, title, duration, organization, details }) {
  return (
    <ol className="flex flex-col md:flex-row relative border-l border-stone-300">
      <li className="mb-10 ml-4">
        <div className="absolute w-3 h-3 bg-green-300 rounded-full mt-1.5 -left-1.5 border-white" />
        ...
        <p className="my-2 font-semibold text-[#001b5e]">
          Empresa:{' '}
